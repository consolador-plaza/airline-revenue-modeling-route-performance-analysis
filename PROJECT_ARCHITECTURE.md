...
```
   ...
   T100 Segment Dataset              DB1B Market Dataset
        ...
        └──────────────┬─────────────────────┘
          ...
          Quarterly Aggregation Layer

        ┌──────────────┴──────────────┐
        ▼                             ▼

 t100_quarterly          db1b_market_quarterly
        ...
        Route-Level Aggregation Layer

        ┌──────────────┴──────────────┐
        ▼                             ▼

t100_route_quarterly   db1b_market_route_quarterly
...
03_validation.sql             04_analysis.sql
